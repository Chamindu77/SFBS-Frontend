...
export const register = (name, email, password, role) => async (dispatch) => {
  ...
  try {
    const res = await axios.post('https://keen-meerkat-53eff3.netlify.app/api/v1/auth/register', body, config);
...
export const login = (email, password) => async (dispatch) => {
  ...
  try {
    const res = await axios.post('https://sfbs-backend-bxu9w3s7d-chamindu-nipuns-projects.vercel.app/api/v1/auth/login', body, config);
